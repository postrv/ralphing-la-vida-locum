...
pub use thresholds::{
    LanguageRegression, LintRegressionResult, LintRegressionSeverity, LintRegressionThresholds,
    RegressionThresholds, WarningTrendDirection,
};
...
mod tests {
    ...
    // ------------------------------------------------------------------------
    // RegressionThresholds tests (integration tests via re-export)
    // ------------------------------------------------------------------------
